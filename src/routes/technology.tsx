...
export const Route = createFileRoute("/technology")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Managed IT Services, Cyber Security, Cloud, Web & App Development, Blockchain, ERP, Network Connectivity and IT Consulting from Dastute Technologies." },
      { property: "og:title", content: "Technology Services — Dastute Technologies" },
      { property: "og:description", content: "Core technology consulting and engineering capabilities serving UK, India and Singapore." },
  ...
  return (
    <SiteLayout>
      ...
      <section className="px-6 py-24 md:py-32 max-w-7xl mx-auto">
        <span className="font-mono text-[10px] uppercase tracking-[0.2em] text-primary block mb-6">/ Technology Practice</span>
        <h1 className="text-5xl md:text-7xl font-bold tracking-tight leading-[0.95] text-balance max-w-4xl">
          Infrastructure, security<br />and software — simplified.
        </h1>
        <p className="mt-8 max-w-xl text-muted-foreground text-lg">
          Ten core disciplines covering the entire technology lifecycle, from local office helpdesk to audited on-chain smart contracts.
        </p>
      ...
      <section className="px-6 py-24 max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-end">
          <div>
            <h3 className="text-3xl md:text-4xl font-bold tracking-tight">Need digital marketing too?</h3>
            <p className="mt-4 text-muted-foreground max-w-md">
              Our marketing practice handles brand strategy, visual identity, paid search, SEO and advertising to align your launch.
            </p>
          </div>
          <div className="flex md:justify-end gap-4">
            <Link to="/marketing" className="inline-flex items-center gap-2 border border-foreground px-6 py-3 text-sm font-medium hover:bg-foreground hover:text-background transition-colors">
