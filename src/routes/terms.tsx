  ...
  head: () => ({
    meta: [
      { title: "Terms of Service — Dastute Technologies" },
      {
        name: "description",
        content:
          "Terms of Service for Dastute Technologies Limited. Governing terms for use of our website and engagement of our consulting services.",
      },
      {
        property: "og:title",
      ...
      <section className="border-t border-border">
        <div className="max-w-4xl mx-auto px-6 py-16 space-y-16">
          ...
          <article>
            ...
            <div className="space-y-4 text-sm text-muted-foreground leading-relaxed pl-10">
              <p>
                ...
                agreement between you ("Client", "you") and Dastute Technologies
                Limited ("Company", "we", "us"), a company registered in England
                and Wales under Company Number 17019407 with its registered
                office at 128 City Road, London, EC1V 2NX.
              </p>
              <p>
          ...
          <article className="border-t border-border pt-16">
            ...
            <div className="space-y-4 text-sm text-muted-foreground leading-relaxed pl-10">
              <p>
                Dastute Technologies provides technology consulting, software
                engineering, blockchain development, cybersecurity, cloud
                services, brand strategy, identity design, and marketing
                services ("Services").
              </p>
              <p>
                Specific services, deliverables, timelines and fees will be
                agreed in a separate Statement of Work ("SOW") or engagement
                letter, which forms part of these Terms. In the event of
                conflict between these Terms and an SOW, the SOW shall prevail.
              </p>
            </div>
          </article>
          ...
          <article className="border-t border-border pt-16">
            ...
            <div className="space-y-4 text-sm text-muted-foreground leading-relaxed pl-10">
              <p>
                ...
                design elements, code, and documentation — is the property of
                Dastute Technologies Limited or its licensors, and is protected
                by copyright, trademark and other intellectual property laws.
              </p>
              <p>
                Upon full payment for Services, intellectual property rights in
                bespoke deliverables created exclusively for the Client shall
                transfer to the Client, unless otherwise specified in the
                applicable SOW.
              </p>
              <p>
                Pre-existing intellectual property, methodologies, frameworks
                and tools developed by Dastute Technologies remain our property.
                We grant the Client a non-exclusive, perpetual licence to use
                such materials as incorporated into deliverables.
              </p>
            </div>
          </article>
          ...
          <article className="border-t border-border pt-16">
            ...
            <div className="space-y-4 text-sm text-muted-foreground leading-relaxed pl-10">
              <p>
                Fees for Services are set out in the applicable SOW. Unless
                otherwise agreed:
              </p>
          ...
          <article className="border-t border-border pt-16">
            ...
            <div className="space-y-4 text-sm text-muted-foreground leading-relaxed pl-10">
              <p>
                ...
                sensitive information disclosed during the course of an
                engagement. This obligation survives termination of the
                engagement for a period of two (2) years.
              </p>
              <p>
                Confidentiality obligations do not apply to information that is
                publicly available, independently developed, or disclosed under
                legal compulsion.
              </p>
            </div>
          </article>
          ...
          <article className="border-t border-border pt-16">
            ...
            <div className="space-y-4 text-sm text-muted-foreground leading-relaxed pl-10">
              <p>
                Either party may terminate an engagement by providing 30 days'
                written notice, unless otherwise specified in the applicable
                SOW.
              </p>
              <p>
                Upon termination, the Client shall pay for all Services rendered
                up to the effective date of termination. All deliverables
                completed and paid for shall be transferred to the Client.
              </p>
              <p>
                Sections relating to Intellectual Property, Confidentiality,
          ...
          <article className="border-t border-border pt-16">
            ...
            <div className="space-y-4 text-sm text-muted-foreground leading-relaxed pl-10">
              <p>
                ...
                up-to-date, we make no warranties or representations of any kind
              ...
              <p>
                ...
                or to interfere with the website's operation.
              </p>
            </div>
          </article>
          ...
          <article className="border-t border-border pt-16">
            ...
            <div className="space-y-4 text-sm text-muted-foreground leading-relaxed pl-10">
              <p>
                ...
                laws of England and Wales. Any dispute arising from these Terms
                shall be subject to the exclusive jurisdiction of the courts of
                England and Wales.
              </p>
              <p>
                Before commencing legal proceedings, both parties agree to
                attempt to resolve disputes through good-faith negotiation for a
          ...
          <article className="border-t border-border pt-16">
            ...
            <div className="space-y-4 text-sm text-muted-foreground leading-relaxed pl-10">
              <p>
                ...
                will be effective upon posting to this page with an updated
