...
function ServicesPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(SiteLayout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "px-6 py-24 md:py-32 max-w-7xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[10px] uppercase tracking-[0.2em] text-primary block mb-6", children: "/ Services" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-8 max-w-xl text-muted-foreground text-lg", children: "12 specialist services spanning managed infrastructure, cybersecurity, development, cloud and advisory — delivered by experienced teams across the UK, India and Singapore." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 flex flex-wrap gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/technology", className: "inline-flex items-center gap-2 border border-foreground px-5 py-3 text-xs uppercase tracking-widest font-medium hover:bg-foreground hover:text-background transition-colors", children: [
          "Technology Practice ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { "aria-hidden": true, children: "↗" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/marketing", className: "inline-flex items-center gap-2 border border-foreground px-5 py-3 text-xs uppercase tracking-widest font-medium hover:bg-primary hover:text-white hover:border-primary transition-colors", children: [
          "Digital Marketing ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { "aria-hidden": true, children: "↗" })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto", children: SERVICES.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: `grid md:grid-cols-[100px_1fr_1fr] gap-8 md:gap-12 p-8 md:p-12 ${i !== 0 ? "border-t border-border" : ""}`, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[10px] uppercase tracking-widest text-muted-foreground block mb-4", children: "Capabilities" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: s.tags.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-3 py-1 border border-border rounded-full text-[10px] uppercase", children: t }, t)) })
      ] })
    ] }, s.code)) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "px-6 py-24 max-w-7xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end gap-6 mb-16", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xs font-mono uppercase tracking-[0.2em] text-muted-foreground", children: "Industry Focus" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px flex-1 bg-border" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-px bg-border border border-border", children: ["Manufacturing", "Transportation & Logistics", "Healthcare", "Banks & Insurance", "Consulting Providers", "Non Profit", "Fintech", "Dating Apps"].map((industry) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-background p-6 hover:bg-foreground hover:text-background transition-colors duration-300 group", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-bold", children: industry }) }, industry)) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "border-t border-border px-6 py-24 max-w-7xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-12 items-end", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-3xl md:text-4xl font-bold tracking-tight", children: "Need a tailored solution?" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-muted-foreground max-w-md", children: "We schedule a call at your convenience, do a discovery and consulting meeting, and prepare a proposal tailored to your specific needs." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex md:justify-end gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/project-estimator", className: "inline-flex items-center gap-2 border border-foreground px-6 py-3 text-sm font-medium hover:bg-foreground hover:text-background transition-colors", children: [
          "Project Estimator ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { "aria-hidden": true, children: "↗" })
        ] }),
